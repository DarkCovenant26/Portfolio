...
export const projects: Project[] = [
    {
        ...
        solution: "Leveraged AI-driven data analysis to architect a custom Pandas-based ingestion engine, automating the parsing and database synchronization of massive SCF datasets.",
        impact: "Automated 1000+ control mappings; 45% reduction in audit reporting time through real-time readiness scoring.",
        tags: ["AI-Augmented", "Django", "SCF 2024", "Pandas", "RapidFuzz", "Celery"],
